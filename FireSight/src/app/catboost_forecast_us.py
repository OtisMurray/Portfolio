...
OUTPUT_COMPARISON_PATH = OUTPUT_DIR / "catboost_model_comparison_test_2024_2025.csv"
OUTPUT_THRESHOLDS_PATH = OUTPUT_DIR / "catboost_threshold_metrics_test_2024_2025.csv"
OUTPUT_IMPORTANCE_PATH = OUTPUT_DIR / "catboost_feature_importance.csv"
OUTPUT_TEST_PRED_PATH = OUTPUT_DIR / "catboost_test_predictions_2024_2025.csv"
OUTPUT_PROJECTION_PATH = OUTPUT_DIR / "catboost_projection_2026_jun_oct.csv"
...
fit_start = time.time()
eval_model.fit(X_train, y_train, eval_set=(X_test, y_test), use_best_model=False)
