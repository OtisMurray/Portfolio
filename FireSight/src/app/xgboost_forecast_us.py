...
OUTPUT_COMPARISON_PATH = OUTPUT_DIR / "xgboost_model_comparison_test_2024_2025.csv"
OUTPUT_THRESHOLDS_PATH = OUTPUT_DIR / "xgboost_threshold_metrics_test_2024_2025.csv"
OUTPUT_IMPORTANCE_PATH = OUTPUT_DIR / "xgboost_feature_importance.csv"
OUTPUT_TEST_PRED_PATH = OUTPUT_DIR / "xgboost_test_predictions_2024_2025.csv"
OUTPUT_PROJECTION_PATH = OUTPUT_DIR / "xgboost_projection_2026_jun_oct.csv"
...
def build_model(y: pd.Series) -> XGBClassifier:
...
eval_model = build_model(y_train)
...
projection_model = build_model(y_full_train)
